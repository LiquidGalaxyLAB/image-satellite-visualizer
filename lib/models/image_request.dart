...
class ImageRequest {
  ...
  String getSentinelHubRequestUrl() {
    return "https://services.sentinel-hub.com/ogc/wms/b54cb4a9-dbfc-4953-a1bf-12d6819d756b?REQUEST=GetMap&CRS=EPSG:4326&BBOX=${this.getBoundaries()}&LAYERS=${this.layers.join(',')}&WIDTH=${this.getResolutions()["width"]}&HEIGHT=${this.getResolutions()["height"]}&FORMAT=image/jpeg&TIME=2016-03-29/${this.time}${this.getCloudCoverage()}";
  }
